...
function renderProducts(products) {
  ...
  products.forEach((p) => {
    const mainCategory = p.mainCategory || "Uncategorized";
    const subCategory = p.subCategory || "Uncategorized";
  ...
  <p>
    ...
    <span class="colon">:</span>
    <span class="value masked-highlight">🔒${p.maskedCode || "🔒 N/A"}</span>
  </p>
  <small class="footnote">🔒 Code is for reference purposes only</small>
`;
